declare module 'notifme-sdk' {
    ...
    export type NotificationStatus = {
      ...
      channels?: {[channel in ChannelType]: {
        id: string,
        providerId?: string
      }},
    ...
    export type EmailProvider = {
      ...
      type: 'custom',
      id: string,
      send: (EmailRequest) => Promise<string>
    } | {
    ...
    export type LoggerProvide = {
      type: "logger"
    }
  
    export type Provider = EmailProvider | SmsProvider | PushProvider | WebpushProvider | SlackProvider | LoggerProvide
    ...
    export type EmailRequest = RequestMetadata & {
      ...
      headers?: {[key: string]: string | number | boolean},
      customize?: (string, EmailRequest) => Promise<EmailRequest>
    }
